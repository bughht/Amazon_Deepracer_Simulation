...
class openvino_node:
    def __init__(self) -> None:
        ...
        self.NETWORK_PATH = "/home/bughht/deepracer/Electro_RaceCar/models/ssdlite_FP32"
    ...
    def detect_STOP(self):
        ...
        for frame_idx in range(2):
            ...
            if self.COCO_STOPSIGN in self.result_ir[frame_idx, :, 1]:
                # pos = np.where(
                #     self.result_ir[frame_idx, :, 1] == self.COCO_STOPSIGN)[0][0]
                # if self.result_ir[frame_idx, pos, 2]-self.result_ir[frame_idx, pos, 4] > 0.1:
