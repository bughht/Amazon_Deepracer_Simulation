...
class Key_Cam:
    def __init__(self) -> None:
        ...
        self.pub = rospy.Publisher("/deepracer1/ackermann_cmd_mux/output", AckermannDriveStamped, queue_size=10)
        self.pub_key()
    ...
    def pub_key(self):
        ...
        while True:
            ...
            print("Keyboard Input:{},Speed:{},Angle:{}".format(key,self.speed,self.angle))
